...
INSERT INTO CARRIER_SERVICE_CODE (CARRIER_CODE, CARRIER_SHIPMENT_SERVICE, DESCRIPTION, CREATED_DATE_TIME, CREATED_USER, LAST_UPDATED_DATE_TIME, LAST_UPDATED_USER) values ('UPS', 'SERVICE', 'DESCRIPTION', now(), 'user', now(), 'user');
