...
public class HomeController {
    ...
    public ResponseEntity<String> homeAdmin() {
		Gson gson = new Gson();
		String message = "This is the admin area of Gallery service running at port: " + env.getProperty("local.server.port");
        return ResponseEntity.ok(gson.toJson(message));
    }
    ...
    public ResponseEntity<String> demo() {
        Gson gson = new Gson();
        String message = "This is a Gallery Service";
        return ResponseEntity.ok(gson.toJson(message));
    }
}