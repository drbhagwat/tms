...
public class GroupsController {
    ...
    public Groups getGroupByName(@PathVariable String name) {
        ...
        Groups groups = groupsList.stream().findFirst().orElseThrow(() -> new GroupNotFound("Group " + name + "does not exists"));
        List<Menu> menuList = groups.getMenuList().stream().filter(menu -> menu.getPath() == null).collect(Collectors.toList());
        groups.setMenuList(menuList);
        return groups;
    }
    ...
    public ResponseEntity<String> updateGroupsByName(@RequestBody Groups groups, @PathVariable String name) {
    ...
    public ResponseEntity<String> deleteGroupsByName(@PathVariable String name) {
